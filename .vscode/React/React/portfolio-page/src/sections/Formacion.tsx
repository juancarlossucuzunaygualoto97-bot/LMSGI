...
const formacion = [
  {
    id: 1,
    title: 'Ciclo Grado Medio en SMR',
    href: '#',
    description:
  ...
  {
    id: 3,
    title: 'Curso de especiaización en Ciberseguridad',
    href: '#',
    description:
  ...
  return (
    <div className="bg-gray-900 py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-4xl font-semibold tracking-tight text-pretty text-white sm:text-5xl">Titulaciones Academicas</h2>
        ...
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-700 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {formacion.map((titulo) => (
            <article key={titulo.id} className="flex max-w-xl flex-col items-start justify-between 
                                                border-4 border-indigo-500/100 rounded-xl p-3 hover:bg-red-100">
